		...
		<div class="main-container">
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
							...
							<table class="data-table table stripe hover nowrap">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php //echo currency_format_d($arrayOb[$i]->getGia());?></td>
					...
					<div class="page-header">
					<a href="./addTypePage.php" class="btn btn-info">Thêm loại</a>
					</div>
					<!-- dstype -->
					<div class="card-box mb-30">
						<div class="pd-20">
										...
										<td>
											<div class="dropdown">
												...
												>
													...
													<a class="dropdown-item" href="./addTypePage.php?action=update_form_type&id=<?php //echo $row['id']?>&type_name=<?php //echo $row['tenloai']?>"
														><i class="dw dw-edit2"></i> Sửa</a
													>
													<a class="dropdown-item" href="../../controllers/admin/typeController.php?action=delete_type&id=<?php //echo $row['id']?>"
														><i class="dw dw-delete-3"></i> Xóa</a
													>
												</div>
											</div>
